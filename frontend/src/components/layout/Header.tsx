    ...
    <>
        ...
        <div className="h-16 px-4 md:px-6 flex items-center justify-between gap-4 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <button
              ...
              className="p-2 -ml-1.5 rounded hover:bg-surface-container text-on-surface-variant hover:text-on-surface flex items-center justify-center transition-colors focus:outline-none"
            ...
            >
              <div className="w-8 h-8 rounded bg-primary flex items-center justify-center text-on-primary font-headline font-bold text-base shadow-sm">
                AI
              </div>
              <div className="flex flex-col min-w-0">
                ...
                <span className="font-headline text-sm md:text-base font-bold text-on-surface truncate">
                  AssistIQ Console
                </span>
              </div>
            </div>
          ...
          {stats && isStaff && (
            <div className="hidden lg:flex items-center gap-2 bg-surface-container-lowest px-3 py-1 rounded border border-outline-variant/40 shadow-xs text-xs font-mono">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 bg-surface-container-high hover:bg-surface-container-highest px-2.5 py-1.5 rounded transition-colors border border-outline-variant/40"
              >
              ...
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-64 bg-surface-container-lowest border border-outline-variant/50 rounded shadow-lg py-2 z-50 animate-in fade-in zoom-in-95 duration-100">
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 flex">
          ...
          <div className="relative w-80 max-w-[85vw] bg-surface-container-high border-r border-outline-variant/40 h-full flex flex-col shadow-2xl z-10 animate-in slide-in-from-left duration-200">
            {/* Drawer Header */}
            <div className="h-16 px-5 flex items-center justify-between border-b border-outline-variant/30 bg-surface-container">
              <div className="flex items-center gap-2.5">
                <div className="w-7 h-7 rounded bg-primary flex items-center justify-center text-on-primary font-headline font-bold text-sm">
                  AI
                </div>
                <div>
              ...
              <button
                onClick={() => setMobileMenuOpen(false)}
                className="w-8 h-8 rounded hover:bg-surface-container-highest flex items-center justify-center text-on-surface-variant transition-colors"
              >
